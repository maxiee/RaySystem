...
class ChatSessionsApi {
  ...
  const ChatSessionsApi(this._dio, this._serializers);
  ...
  Future<Response<ChatSessionResponse>> createChatSessionLlmChatSessionsPost({
    ...
    final _path = r'/llm/chat-sessions/';
    ...
    ChatSessionResponse? _responseData;
  ...
  Future<Response<ChatSessionsListResponse>>
    ...
    ChatSessionsListResponse? _responseData;
    ...
    return Response<ChatSessionsListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
