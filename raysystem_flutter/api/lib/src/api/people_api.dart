...
class PeopleApi {
  ...
  Future<Response<PeopleNameResponse>> createPeopleNamePeoplePeopleIdNamesPost({
    ...
    PeopleNameResponse? _responseData;
    ...
    return Response<PeopleNameResponse>(
      data: _responseData,
  ...
  Future<Response<PeopleResponse>> createPeoplePeoplePost({
    ...
    return Response<PeopleResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PeopleListResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PeopleListResponse>> getPeopleListPeopleGet({
    int? page = 1,
    int? pageSize = 10,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    PeopleListResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PeopleListResponse),
            ) as PeopleListResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PeopleListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<PeopleNameResponse>>>
    ...
    BuiltList<PeopleNameResponse>? _responseData;
    ...
    return Response<BuiltList<PeopleNameResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<PeopleResponse>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<PeopleResponse>>> searchPeoplePeopleSearchGet({
    ...
    BuiltList<PeopleResponse>? _responseData;
    ...
    return Response<BuiltList<PeopleResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
