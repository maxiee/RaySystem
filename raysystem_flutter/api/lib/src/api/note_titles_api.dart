...
class NoteTitlesApi {
  ...
  const NoteTitlesApi(this._dio, this._serializers);
  ...
  Future<Response<NoteTitleResponse>> addNoteTitleNotesNoteIdTitlesPost({ 
    ...
    NoteTitleResponse? _responseData;
    ...
    return Response<NoteTitleResponse>(
      data: _responseData,
  ...
  Future<Response<BuiltList<NoteTitleResponse>>> getNoteTitlesNotesNoteIdTitlesGet({ 
    ...
    BuiltList<NoteTitleResponse>? _responseData;
    ...
    return Response<BuiltList<NoteTitleResponse>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
