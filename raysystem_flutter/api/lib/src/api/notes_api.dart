...
class NotesApi {
  ...
  Future<Response<NoteTreeResponse>> getChildNotesNotesTreeChildrenGet({
    ...
    final _path = r'/notes/tree/children';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    NoteTreeResponse? _responseData;
    ...
    return Response<NoteTreeResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<NotesListResponse>> listRecentNotesNotesGet({
    ...
    NotesListResponse? _responseData;
    ...
    return Response<NotesListResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [q] - Search query for note titles
  /// * [limit] - Maximum number of notes to return
  /// * [offset] - Number of notes to skip
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
